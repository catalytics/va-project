...
function updateData(){
    ...
    var output = {
        uni1: d3.select("#u1").property("value"),
        uni2: d3.select("#u2").property("value"),
        yearChoice: d3.select("#year").property("value")
    };
...
//  Main Source = http://bl.ocks.org/biovisualize/4348024 
    ...
    updateTernary(output.uni1,output.uni2);
};

// Call inputs on button click
console.log("I Loaded nothing yet!");
updateData();
